...
ORG_ROLES = {
    ...
    "Clinical Supervisor": (
        ...
        ["org.mhp.view", "org.mhp.edit", "org.staff.view", "org.billing.view"],
    ),
    "Front Desk": (
        "ORG_TEMPLATE",
        "Handles outpatient/MHP registration and appointment check-in; no access to clinical notes or staff management.",
